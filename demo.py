...
nr, maxnl, m = 41, 41, 1  # resolution
field_modes = [SphericalHarmonicMode("tor", 1, 0, "3 Sqrt[pi] r(1-r^2)")]  # define background field
model = MagnetoCoriolis(nr, maxnl, m)  # construct model object
...
# compute eigenvalue and eigenvector near a target eigenvalue
...
# construct physical transforms at physical grids
